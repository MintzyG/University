...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Adaptação Prof Ausberto S. Castro Vera, UENF-CCT-LCMAT-CC
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mais adaptações Sophia Hoffmann Fernandes Braga
%----------------------------------------------------------------------------------------
...
\usepackage[explicit]{titlesec} % Allows customization of titles
...
\newenvironment{remark}{\par\vspace{10pt}\small % Vertical white space above the remark and smaller font size
  ...
  \newcommand{\@mypartnumtocformat}[2]{%
    ...
    \noindent\colorbox{ocre!20}
    {
      \strut\parbox[c][.7cm]
      {\ecart}
      {\color
        {ocre!70}
        \Large\sffamily\bfseries\centering#1
      }
    }
    \hskip\esp\colorbox{ocre!40}
    {
      \strut\parbox[c][.7cm]
      {\linewidth-\ecart-\esp}
